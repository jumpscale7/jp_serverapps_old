...
level  = "info"
file   = "/opt/jsbox_data/var/influxdb/logs/log.txt"         # stdout to log to standard out

# Configure the admin server
[admin]
port   = 8083              # binding is disabled if the port isn't set
assets = "/opt/jumpscale/apps/influxdb/admin"
...
dir  = "/opt/jsbox_data/var/influxdb/data/raft"

# election-timeout = "1s"

[storage]
dir = "/opt/jsbox_data/var/influxdb/data/db"
...
dir   = "/opt/jsbox_data/var/influxdb/data/wal"
...
"""
    ...
    #@todo implement seedserver support
    CFGFILE=CFGFILE.replace("$seedservers","")

    j.system.fs.writeFile("$cfgdir/influxdb/config.toml",CFGFILE)
